...
export default function ContactSection() {
  return (
    <footer id="contact" className="relative rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14 px-5 sm:px-8 md:px-10 pt-24 sm:pt-32 pb-12" style={{ background: '#FFFFFF', zIndex: 110 }}>
      <FadeIn as="h2" y={40} className="text-[#0C0C0C] font-black uppercase text-center leading-none tracking-tight" style={{ fontSize: 'clamp(3rem, 12vw, 160px)' }}>
        Contact
      </FadeIn>
      ...
      <FadeIn delay={0.3} className="max-w-3xl mx-auto mt-12 text-[#0C0C0C] font-light leading-relaxed" style={{ fontSize: 'clamp(0.85rem, 1.3vw, 1.05rem)', opacity: 0.7 }}>
